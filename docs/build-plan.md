...
- QEMU for the fast inner loop (`qemu-system-x86_64 -enable-kvm -m 4G -cdrom out/unemployed-os.iso`) — boots your ISO in seconds instead of burning a USB every test
